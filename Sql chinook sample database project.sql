...
SELECT employees.FirstName AS emp_first, employees.LastName AS emp_last, customers.FirstName AS cust_first, customers.LastName AS cust_last, customers.Country, Invoices.Total FROM chinook.employees 
JOIN chinook.customers ON employees.EmployeeId = customers.SupportRepId JOIN chinook.invoices ON customers.CustomerId = Invoices.CustomerId
