--The database contains vacation resort data which consists of three tables, one for booking, one for facilities and one for members.

--The following queries will reflect what could be asked of a SQL consultant in this work environment:
